Shader "Unidork/Skybox/Blendable_Cubemap"
{
    Properties
    {
        ...
        [NoScaleOffset] _FirstSkybox ("First Skybox Cubemap (HDR)", Cube) = "grey" {}
        [NoScaleOffset] _SecondSkybox ("Second Skybox Cubemap (HDR)", Cube) = "grey" {}
    }
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            samplerCUBE _FirstSkybox;
            samplerCUBE _SecondSkybox;
            half4 _FirstSkybox_HDR;
            half4 _SecondSkybox_HDR;
            half4 _Tint;
            half _Exposure;
            float _XRotation;
            float _YRotation;
            ...
            {
                half4 firstTex = texCUBE (_FirstSkybox, i.texcoord);
                half3 firstColor = DecodeHDR (firstTex, _FirstSkybox_HDR);
                ...
                half4 secondTex = texCUBE (_SecondSkybox, i.texcoord);
                half3 secondColor = DecodeHDR (secondTex, _SecondSkybox_HDR);
