...
namespace UnderdorkStudios.UnderTools.Extensions
{
    public static class CollectionExtensions
    {
        ...
        /// <summary>
        /// Adds and item to the list and sorts it in place.
        /// </summary>
        /// <param name="list">List.</param>
        /// <param name="itemToAdd">Item to add.</param>
        /// <typeparam name="T">Item type.</typeparam>
        public static void AddAndSort<T>(this List<T> list, T itemToAdd)
        {
	        list.Add(itemToAdd);
	        list.Sort();
        } 
        ...
        /// <summary>
        /// Checks if one collection contains all elements of the other collection.
        /// </summary>
        /// <param name="collection">Collection to check.</param>
        /// <param name="otherCollection">Collection to check against.</param>
        /// <typeparam name="T">Element type of the collection.</typeparam>
        /// <returns>
        /// True if all elements of <paramref name="otherCollection"/> are contained in <paramref name="collection"/>,
        /// False if elements are missing or either of collections is empty.
        /// </returns>
        public static bool ContainsAll<T>(this ICollection<T> collection, ICollection<T> otherCollection)
        {
	        ...
	        int otherCollectionCount = otherCollection.Count;
	        
	        if (collectionCount == 0 || otherCollectionCount == 0)
	        {
		        return false;
	        }

	        foreach (T element in otherCollection)
	        {
